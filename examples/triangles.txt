...
// Shadertoy: https://www.shadertoy.com/view/wdsfRl
// Fork of Plexus with triangles by latitude: https://www.shadertoy.com/view/wtcXWr
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	for(float i = 0.0; i < 1.0; i += 1.0 / 4.0){
		...
		m += layer(uv * size + i * 20.0) * fade* 0.25;
	}
